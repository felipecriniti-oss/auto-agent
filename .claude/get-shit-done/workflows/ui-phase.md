...
```markdown
Read C:/Users/pc/auto-agent/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Users/pc/auto-agent/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Users/pc/auto-agent/.claude/agents/gsd-ui-checker.md for instructions.
