...
```
Task(
  prompt="Read C:/Users/pc/auto-agent/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/pc/auto-agent/.claude/get-shit-done/templates/SECURITY.md`
